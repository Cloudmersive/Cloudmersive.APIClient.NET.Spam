...
namespace Cloudmersive.APIClient.NET.Spam.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpamDetectionResponse : Dictionary<String, >,  IEquatable<SpamDetectionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public SpamDetectionResponse(bool? cleanResult = default(bool?)) : base()
        {
