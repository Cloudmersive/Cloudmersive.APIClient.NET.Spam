# Cloudmersive.APIClient.NET.Spam.Model.SpamDetectionAdvancedFormSubmissionRequest
...
------------ | ------------- | ------------- | -------------
**InputFormFields** | [**List&lt;SpamDetectionAdvancedFormField&gt;**](SpamDetectionAdvancedFormField.md) | Form fields and values that you received in your form submission | [optional] 
