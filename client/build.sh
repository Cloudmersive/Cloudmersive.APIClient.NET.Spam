...
${nuget_cmd} install src/Cloudmersive.APIClient.NET.Spam/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Cloudmersive.APIClient.NET.Spam.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Cloudmersive.APIClient.NET.Spam.dll \
-recurse:'src/Cloudmersive.APIClient.NET.Spam/*.cs' \
-doc:bin/Cloudmersive.APIClient.NET.Spam.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Cloudmersive.APIClient.NET.Spam.dll was created successfully"
fi
